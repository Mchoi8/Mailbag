...
app.get("/mailboxes", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                imapWorker = new IMAP.Worker(ServerInfo_1.imapInfo);
...
app.post("/messages", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                smtpWorker = new SMTP.Worker(ServerInfo_1.smtpInfo);
...
app.post("/contacts", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var contactsWorker, contact_list, check, i, contact, contact, inError_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 8, , 9]);
                ...
                return [4 /*yield*/, contactsWorker.listContacts()];
            case 1:
                contact_list = _a.sent();
                check = true;
                i = 0;
                _a.label = 2;
            case 2:
                if (!(i < contact_list.length)) return [3 /*break*/, 5];
                if (!(contact_list[i].name == inRequest.body.name)) return [3 /*break*/, 4];
                check = false;
...
// Update a contact #.
app.post("/contacts/:name", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
